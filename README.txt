...
spelling is not universal and THERE ARE TYPOS, so if "ctrl-f" doesnt catch it then check with different spelling(for example, sobel filter vs sobel operator,, gaus vs gaussian,, upsample vs upscaling)
